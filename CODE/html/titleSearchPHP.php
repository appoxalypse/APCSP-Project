...
<html>
  ...
  <head>
    <title>Results | WN Updates</title>
  ...
  <body>
    ...
    <?php
      ...
      if (isset($_POST['submit'])) {
        ...
        echo '<br><p style="text-align:center; font-size:20px;">Web Novels with titles that start with the letter: ' . $_POST['alphabet'] . "</p>";
        
        echo "<br><br>";
        
        //define query
        $query = "SELECT title, author, genre, rating FROM web_novel WHERE alphabet='" . $_POST['alphabet'] . "';";
